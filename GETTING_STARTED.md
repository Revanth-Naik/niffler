...
Opens your browser to `http://localhost:8501` automatically. If it doesn't, open that URL yourself. Four pages in the left sidebar: home, stock lookup, top 50 predictions, accuracy tracker, and model insights — plus Dumbledore, a floating chat button in the bottom-right corner on every page (free, local, no API key needed).
